...
if [ $? = 0 ]; then
       ...
       mkdir /home/ubuntu/shellCourse/Respaldos/$nombreCarpeta$fechaActual
       aws s3 cp s3://p3rolixbucket2/PruebaBucket/RespaldosAWS/$nombreDescarga  /home/ubuntu/shellCourse/Respaldos/$nombreCarpeta$fechaActual
